...
public class MockZh03AGasSensorClient extends Zh03AGasSensorClient {
	public MockZh03AGasSensorClient(String description, Supplier<Long> sleepMillisSupplier,
		...
		super(description,
				c -> new Zh03AMockGasSensorReader(c, sleepMillisSupplier, gasSensorEventSupplier, exceptionConsumer),
