...
public class RandomSi7021GasSensorEventSupplier implements Supplier<GasSensorEvent> {
	private static final int TEMPERATURE_BOUND = 100;
	private static final int HUMIDITY_BOUND = 100;
	...
	public GasSensorEvent get() {
		return new GenericGasSensorEvent(
				new GasSensing(Si7021.TEMPERATURE_DESCRIPTION, new BigDecimal(random.nextInt(TEMPERATURE_BOUND)),
						Si7021.TEMPERATURE_UNIT),
				new GasSensing(Si7021.HUMIDITY_DESCRIPTION, new BigDecimal(random.nextInt(HUMIDITY_BOUND)),
